                        ...
                        >
                            <div>
                                <div className="flex justify-between items-start mb-4">
                                    ...
                                    <span className={`px-3 py-1 rounded-full text-xs font-bold ${statusColor(job.status)}`}>
                                        {job.status === 'PAID' ? 'READY' : job.status.replace('_', ' ')}
                                    </span>
                                </div>
                            ...
                            <div className="pt-4 border-t border-gray-100 dark:border-gray-700">
                                ...
                                {job.status === 'COMPLETED' && (
                                    <button disabled className="w-full py-2 bg-gray-100 dark:bg-gray-700 text-gray-400 rounded-lg font-medium cursor-not-allowed flex items-center justify-center gap-2">
